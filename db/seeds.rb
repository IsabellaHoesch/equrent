...
Offer.create(name: "Ping-pong rackets", offer_type: "equipment", description: "2 years old", sport_type: "ping-pong", address: "Hessstrasse 13, München", offer_img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdWgqXDkSu9eZ7YrSwRd-cZz8QwG1iTH03sA&usqp=CAU", price: 10, user: user1)
Offer.create(name: "Great volleyball", offer_type: "equipment", description: "needs air", sport_type: "volleyball", address: "Schleißheimer Straße 60, München", offer_img: "https://heidelberger-tv.de/wp-content/uploads/miguel-teirlinck-VDkRsT649C0-unsplash_Volleyball-1-1080x675.jpg", price: 20, user: user1)
